...
public class NameGenerationTool {
  ...
  /**
   * Get table name from CXEntity
   *
   * @param clazz annotated type element with CXEntity
   * @return path
   */
  public static String getTableName(TypeElement clazz) {
    return clazz.getAnnotation(CXEntity.class).tableName();
  }

  /**
   * Get table name from CXEntity
   *
   * @param clazz annotated class with CXEntity
   * @return path
   */
